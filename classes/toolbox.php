    ...
    public static function create_section_image($tempfile, $storedfilerecord, $sectionimage, $courseformat) {
        ...
        try {
            ...
            if ($convertsuccess == true) {
                ...
                $icbc = self::hex2rgb($courseformat->get_settings()['imagecontainerbackgroundcolour']);
                self::setup_displayed_image($sectionimage, $storedfilerecord['contextid'], $courseformat->get_courseid(), $courseformat->get_settings(), $icbc, $mime);
            } else {
